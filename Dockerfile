...
RUN     apt-get update \
        && apt-get upgrade -y \
        && apt-get install -y alsa-utils libgtk-3-0 libnotify4 libnss3 libxss1 libxtst6 xdg-utils libatspi2.0-0 libappindicator3-1 libsecret-1-0 desktop-file-utils wget curl \
